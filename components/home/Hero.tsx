...
export default async function Hero({
  ...
  return (
    <div
      ...
      }  flex-col  flex justify-between w-full h-full  overflow-hidden relative  `}
    >
      <div className=" bg-neutral-950 sm:w-[60%] text-white px-5 py-10 sm:p-12 box-border h-1/2  sm:h-full flex items-center  ">
        ...
        >
          <h1 className=" font-medium  text-3xl sm:text-5xl md:text-6xl xl:text-7xl 2xl:text-8xl    w-full sm:w-[85%]  ">
            {t("heroText1")}
          </h1>
          <h2 className="text-xl md:text-3xl 2xl:text-4xl opacity-80 font-light">
            {t("heroText2")}
          </h2>
